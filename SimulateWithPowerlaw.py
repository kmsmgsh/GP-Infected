...
#InitialGP=0.001*np.ones(population*(population-1)/2)
#Metro=mp3.multiMetropolis(1000,None,[0.3,0.2,0.3],None,InitialGP,GPDoc,estimate.GaussianPriorGP,"Change","c")
...
gp.kernelFunctonPlotRebuild(model1.DistanceMatrix,Metro.recordGP,[0.4,0.1,0.3],"powerlaw",[1000,20,1.5,0.3],InitialGP)
